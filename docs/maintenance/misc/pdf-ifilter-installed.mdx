...
<DownloadButton 
  href="/bp/downloads/configure-ifilter-sharepoint.zip"
  filename="configure-ifilter-sharepoint.zip"
  fileSize="1.6 KB"
  fileType="ZIP"
  description="PowerShell script to configure PDF iFilter for SharePoint"
/>
