...
<DownloadButton 
  href="/bp/downloads/get-bploopbackcheckconfig.zip"
  filename="get-bploopbackcheckconfig.zip"
  fileSize="1.2 KB"
  fileType="ZIP"
  description="PowerShell script to retrieve loopback check configuration"
/>
