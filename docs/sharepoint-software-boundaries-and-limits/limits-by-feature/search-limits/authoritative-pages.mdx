...
<DownloadButton 
  href="/bp/downloads/get-bpssaauthoritativepages.7z"
  filename="get-bpssaauthoritativepages.7z"
  fileSize="1.0 KB"
  fileType="7Z"
  description="PowerShell script to check authoritative pages configuration"
/>
